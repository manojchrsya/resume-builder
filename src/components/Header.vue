...
<template>
  <header class="header">
    <div class="header-name" contenteditable="false" :header.name>{{ header.name }}</div>
    <div class="header-title" contenteditable="false" :header.title>{{ header.title }}</div>
    <div class="header-contact">
      <span>
        ...
        <span contenteditable="false" data-path="header.email">{{ header.email }}</span>
        ...
        <span contenteditable="false" data-path="header.phone">{{ header.phone }}</span>
      </span>
      <span>
        ...
        <span contenteditable="false" data-path="header.location">{{ header.location }}</span>
      </span>
      <span>
        <svg viewBox="0 0 24 24"><path d="M19 0H5a5 5 0 00-5 5v14a5 5 0 005 5h14a5 5 0 005-5V5a5 5 0 00-5-5zM8 19H5V8h3v11zM6.5 6.7A1.8 1.8 0 114.7 5a1.8 1.8 0 011.8 1.7zM20 19h-3v-5.6c0-1.3-.5-2.2-1.6-2.2a1.7 1.7 0 00-1.6 1.2 2.2 2.2 0 000 .8V19h-3V8h3v1.5a3.2 3.2 0 012.9-1.6c2.1 0 3.3 1.4 3.3 4.3V19z"/></svg>
        <span contenteditable="false" data-path="header.linkedin">{{ header.linkedin }}</span>
      </span>
      <span>
        ...
        <span contenteditable="false" data-path="header.github">{{ header.github }}</span>
      </span>
    </div>
  </header>
</template>
