...
<template>
  <header class="header" :header="header">
    <div class="header-name" contenteditable="true"  data-field="name" @input="handleEditorInput">{{ header.name }}</div>
    <div class="header-title" contenteditable="true" data-field="title" @input="handleEditorInput">{{ header.title }}</div>
